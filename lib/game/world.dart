...
class World extends ParallaxComponent<UmbrellaJump> {
  @override
  Future<void> onLoad() async {
    parallax = await gameRef.loadParallax(
      [
        // ParallaxImageData('game/background/07_Background_Test.jpg'),
        // ParallaxImageData('game/background/07_Background_Test.jpg'),
        ParallaxImageData('game/background/06_Background_Solid.png'),
        ParallaxImageData('game/background/12_Background_Rain4.png'),
